  ...
  call putel_in_namelist(nm,set_omp_thread_outside_solver,'set_omp_thread_outside_solver',-1,'Definition: if positive number of threads used outside the solver')
  call putel_in_namelist(nm,set_omp_thread_during_solver,'set_omp_thread_during_solver',-1,'Definition: if positive number of threads used inside the solver')
