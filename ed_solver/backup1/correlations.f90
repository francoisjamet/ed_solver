MODULE correlations
  ...
  INTERFACE scalprod
   MODULE PROCEDURE scalprod_r,scalprod_c
  END INTERFACE
...
complex(8) function scalprod_c(v1,v2)
implicit none
complex(8) :: v1(:),v2(:)
integer::i
 scalprod_c = 0.d0
 do i=1,size(v1)
  scalprod_c=scalprod_c+conjg(v1(i))*v2(i)
 enddo
end function

real(8) function scalprod_r(v1,v2)
implicit none
real(8) :: v1(:),v2(:)
integer::i
 scalprod_r = 0.d0
 do i=1,size(v1)
  scalprod_r=scalprod_r+v1(i)*v2(i)
 enddo
end function
