...
logical,optional   :: nosync
 ...
 if(rank==0)then
   ...
   write(*,*) '         xwin       -  dump to X11 instead of a ps file'
 ...
 do i=1,num
    ...
    CASE("xwin")
      stop
      if(.not.menu_parsed)then
       wait=.true.
       flag_alternate_display=.true.
       write(*,*) 'open ... displays : ', alternate_display_cycle
       !if(rank==0) call opendisplay(alternate_display_cycle,1,'/XWINDOW')
       write(*,*) ' open display done.....'
      endif
      goto 11
    CASE("build_tree")
