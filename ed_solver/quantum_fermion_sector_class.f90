...
!**************************************************************************
  ...
  SUBROUTINE new_fermion_sector2_from_scratch(SEC,nup,ndo,Ns,NAMBU)
    ...
    if(.not. SEC%not_physical)  CALL split_fermion_sector2(SEC)
...
!**************************************************************************
  ...
  SUBROUTINE copy_fermion_sector2(SECOUT,SECIN)
    ...
    SECOUT%not_physical = SECIN%not_physical
    SECOUT%strideup = SECIN%strideup 
    SECOUT%stridedown=SECIN%strideup 
